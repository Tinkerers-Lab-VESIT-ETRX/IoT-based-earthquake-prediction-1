function myFunction() {
    ...
    const url='https://iot-based-earthquake-predictor-default-rtdb.asia-southeast1.firebasedatabase.app/a_x_data.json';
    ...
    Http.onreadystatechange = () => {
        if (Http.readyState == 4 && Http.status == 200) {
            ...
            if(plotData.length!=0){
                ...
                {
                    title:{
                        text: "X axis accelerometer reading"
                    },
                    axisX:{
...
function myFunction2() {
    ...
    //console.log(selectedDate);
    const Http = new XMLHttpRequest();
    const url='https://iot-based-earthquake-predictor-default-rtdb.asia-southeast1.firebasedatabase.app/a_y_data.json';
    ...
    Http.onreadystatechange = () => {
        if (Http.readyState == 4 && Http.status == 200) {
            ...
            if(plotData.length!=0){
                ...
                {
                    title:{
                        text: "Y axis accelerometer reading"
                    },
                    axisX:{
                        gridColor: "lightgreen" ,
                        gridThickness: 2        
...
function myFunction3() {
    ...
    //console.log(selectedDate);
    const Http = new XMLHttpRequest();
    const url='https://iot-based-earthquake-predictor-default-rtdb.asia-southeast1.firebasedatabase.app/a_z_data.json';
    ...
    Http.onreadystatechange = () => {
        if (Http.readyState == 4 && Http.status == 200) {
            ...
            if(plotData.length!=0){
                ...
                {
                    title:{
                        text: "Z axis accelerometer reading"
                    },
                    axisX:{
                        gridColor: "lightgreen" ,
                        gridThickness: 2        
